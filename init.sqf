...
// выбрать локацию из всех локаций заданного типа и получить её координату
	...
	// определить центр и радиус острова
		...
		// определяем радиус как расстояние от центра до точки [0,0]
		
		_radius = _centerOfMap distance2D [0,0];	
...
// на полученную позицию (но с удалением 50 метров от неё) перенести игрока и создать ему отряд
